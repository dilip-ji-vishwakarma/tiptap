...
const stepData = {
    video: {
        ...
        heading: "Working with React Components"
    },
    ...
    tabs: [
        {
            template: "paragraph",
            name: "Description",
            data: "Components are the building blocks of any React application. You will learn how to create functional and class components, manage their state and props, and understand component lifecycle methods.",
        },
        {
