    ...
    tabs: [
        {
            template: "paragraph",
            name: "Description",
            data: "Before starting this course, it is recommended that you have a basic understanding of HTML, CSS, and JavaScript. Familiarity with modern JavaScript features like ES6 syntax will be beneficial.",
        },
        {
