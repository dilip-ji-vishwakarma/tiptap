    ...
    tabs: [
        {
            template: "paragraph",
            name: "Description",
            data: "To get started with React, you'll need to set up your development environment. This includes installing Node.js, npm, and create-react-app, which will help you bootstrap a new React application quickly.",
        },
        {
