    ...
    tabs: [
        {
            template: "paragraph",
            name: "Description",
            data: "Understanding how React works under the hood will help you make better decisions while building applications. We will delve into concepts like the virtual DOM, reconciliation, and how React updates the UI efficiently.",
        },
        {
