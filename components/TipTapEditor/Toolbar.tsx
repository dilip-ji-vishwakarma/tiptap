...
export const Toolbar = () => {
  ...
  const YoutubeComponent = (type: string) => {
    ...
    currentEditor
      ?.chain()
      .focus()
      .insertContent(`<youtubedraggable-component></youtubedraggable-component>`)
      .run();
  };
